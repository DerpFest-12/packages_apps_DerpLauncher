...
public class DoubleShadowTextView extends TextView {
    ...
    public DoubleShadowTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setShadowLayer(Math.max(mShadowInfo.keyShadowBlur + mShadowInfo.keyShadowOffsetY, mShadowInfo.ambientShadowBlur), 0f, 0f, mShadowInfo.keyShadowColor);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        getPaint().setShadowLayer(mShadowInfo.keyShadowBlur, mShadowInfo.keyShadowOffsetX, mShadowInfo.keyShadowOffsetY, mShadowInfo.keyShadowColor);
        super.onDraw(canvas);
    }
}
