...
public class PredictionRowView extends LinearLayout implements
    ...
    private boolean isAppHidden(ItemInfo item) {
        TrustDatabaseHelper db = TrustDatabaseHelper.getInstance(getContext());
        return db != null && db.isPackageHidden(item.getTargetPackage());
    }
